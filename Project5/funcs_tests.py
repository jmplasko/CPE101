...
class TestCases(unittest.TestCase):
   ...
   def test_mag_filter(self):
      quakes = []
      real_quakes = quake_funcs.read_quakes_from_file("test0.txt")
      quakes.append(quake_funcs.Earthquake("5km S of Gilroy, California", 2.19,
                                           -121.5801697, 36.9580002,
                                           1488173538))
      self.assertEqual(quake_funcs.filter_by_mag(real_quakes,2.19,3),quakes)

   def test_mag_filter_1(self):
      quakes = []
      real_quakes = quake_funcs.read_quakes_from_file("test0.txt")
      quakes.append(quake_funcs.Earthquake("5km S of Gilroy, California", 2.19,
                                           -121.5801697, 36.9580002,
                                           1488173538))
      self.assertNotEqual(quake_funcs.filter_by_mag(real_quakes,2,2.18),quakes)
   ...
   def test_place_filter(self):
      ...
      quakes.append(quake_funcs.Earthquake("5km S of Gilroy, California", 2.19,
                                           -121.5801697, 36.9580002,
                                           1488173538))
      self.assertEqual(quake_funcs.filter_by_place(real_quakes,"california"),quakes)
